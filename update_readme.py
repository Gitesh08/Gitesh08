...
<div align="center" style="background: rgba(30,7,8,0.85); padding: 10px; border-radius: 2px;" onmouseover="this.style.transform='scale(1.02)'" onmouseout="this.style.transform='scale(1)'">
  ...
  <img src="https://github-contributor-stats.vercel.app/api?username={self.username}&limit=3&theme=transparent&combine_all_yearly_contributions=true" alt="Top Contributed Repos" style="border-radius: 6px; box-shadow: 0 4px 10px rgba(148,188,0.2); max-width: 400px;">
</div>"""
